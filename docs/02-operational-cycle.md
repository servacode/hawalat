...
كل حساب/صندوق له **رصيد جارٍ** يزيد وينقص.
**الاصطلاح المعتمد (مطابق للتنفيذ):** `balance = مجموع المدين − مجموع الدائن` (debit − credit).

| الكيان | رصيد موجب (+) يعني | رصيد سالب (−) يعني |
|---|---|---|
| **حساب مكتب صغير** (في دفاتر الكبير) | المكتب الصغير **عليه** (مدين لنا) | المكتب الصغير **له** (دائن علينا) |
| **صندوق وسيط** | **رصيدنا الموجود لديه** (إيداعاتنا) | **علينا له** (سحبنا أكثر مما أودعنا) |
| **صندوق المحل** (نقد) | نقد فعلي موجود | — (لا يكون سالباً عملياً) |
| **حساب أرباح الأجور** (دخل) | — | يتراكم دائناً؛ **يُعرض معكوساً** ليظهر الربح موجباً |

> القاعدة السردية (المشهدان 2 و5): **الاعتماد/الإيداع يزيد الصندوق، وتمرير الحركة ينقصه**؛
> والحركة المقبولة تجعل الصغير **عليه** (المبلغ + الأجور المستحقة).
...
|---|---|---|---|
| حساب المكتب الصغير | مدين (المبلغ + الأجور المستحقة) | **+1015** | أصبح **عليه** للكبير |
| صندوق الوسيط (الوعد) | دائن (المبلغ + رأس مال الأجور) | **−1010** | **نقص الصندوق** (سحبنا منه للتمرير) |
| ربح المكتب الكبير (مذكرة) | + (المستحقة − رأس المال) | **+5** | فرق الأجور |

**تحقق التوازن:** مدين 1015 = دائن (1010 + 5) ✅ · ومجموع الأرصدة (‎+1015 −1010 −5‎) = **صفر** ✅
مثال بإيداع سابق 2000 في الوعد: رصيده بعد الحركة = 2000 − 1010 = **990** (كما في السرد).
**أثر الرصيد:** صندوق الوسيط **ينقص** (سحبنا لتمرير الحركة)، وحساب الصغير **يرتفع مديناً** (زاد ما عليه).

### 4-ب. عند وضع **"مدفوعة"** (Paid)
| الحساب | الأثر | القيمة | التفسير |
|---|---|---|---|
| صندوق المحل (نقد) | مدين (المبلغ + الأجور المستحقة) | **+1015** | استلمنا نقداً |
| حساب المكتب الصغير | دائن (المبلغ + الأجور المستحقة) | **−1015 → 0** | يُصفّى دَينه بالكامل → يعود إلى الصفر |
...
- **إشعار للمكتب الصغير** بأن حركة زبونه سُلِّمت (ملاحظة التجربة الحيّة 7).
- **نهائي مطلق (ملاحظة التجربة الحيّة 9):** بمجرد «تم التسليم» انتهى الأمر —
  **لا تراجع ولا عكس ولا تعديل ولا أي إجراء كان**، لأن الزبون استلم وذهب.
  الإلغاء ممكن **قبل** الاستلام فقط. لذلك تعليم التسليم مسؤولية: لا يُعلَّم إلا بعد التأكد.
